...
for s in subset_sizes:
	...
	run_svm_and_write_output('1a', sub_train_data, sub_train_lable, q1_test_data, q1_test_lable, 1, 'linear', 'auto', 1, False)
	print()
...
for C in C_list:
	print('C =', C)
	print('Q = 2:')
	run_svm_and_write_output('1b', q1_train_data, q1_train_lable, q1_test_data, q1_test_lable, C, 'poly', 'auto', 2, False)
	print('Q = 5:')
	run_svm_and_write_output('1b', q1_train_data, q1_train_lable, q1_test_data, q1_test_lable, C, 'poly', 'auto', 5, False)
	print()
...
for C in C_list:
	print('C =', C)
	run_svm_and_write_output('1c', q1_train_data, q1_train_lable, q1_test_data, q1_test_lable, C, 'rbf', 1.0, 1, False)
	print()
